		...
		<div class="container">
			<div class="crypto-analysis">
					...
					<div class="col-md-12">
						<div class="card">
							<div class="search">
								...
								<h5><i class="fa fa-mug-hot"></i>Recent Hot Event</h5>
							</div>
						</div>
					</div>
				</div>
							...
							<div class="card">
								<div class="favourite">
									<div class="row align-item-center border-bottom pb-3 mb-2 favourite-heading">
										<div class="col-md-6">
											<h3><i class="fa-regular fa-star"></i> Favorites</h3>
										</div>
										<div class="col-md-6">
							...
							<div class="card">
								<div class="investigation">
									<div class="row align-item-center border-bottom pb-3 mb-2 investigation-heading">
										<div class="col-md-6">
											<h3><i class="fa fa-crosshairs"></i>  Investigation</h3>
										</div>
										<div class="col-md-6">
				...
				<div class="unread-alert">
					<div class="col-md-12">
						<div class="card">
							<div class="unread-alert-information">
								<div class="row align-item-center border-bottom pb-3 mb-2 unread-alert-heading">
									<div class="col-md-6">
										<h3><i class="fa-solid fa-triangle-exclamation"></i> Unread Alert(s)</h3>
									</div>
									<div class="col-md-6">
