              ...
              <div class="col-md-12">
                <div class="card crypto-details-heading">
                  <div class="heading d-flex py-3 px-3">
                    <h2><i class="fa-solid fa-circle-info mx-2"></i>Details</h2>
                </div>
            </div>
        </div>
        <div class="details">
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="card card-btc py-3 px-3">
                        <div class="d-flex">
                            ...
                            <div class="btc-information">
                                ...
                                <h5><text class="key_address">{{$chainsight->address}}</text> 

                                    <a href="javascript:void(0)" onclick="copyToClipboard('.key_address')"><i class="fa-solid fa-copy fa-1x mx-2"></i></a>
                                    <a href="#" data-bs-toggle="modal" data-bs-target="#flagModal"><i class="fa-solid fa-flag mx-1"></i></a>
                                </h5>
                                @endif
                            </div>
                        </div>
                ...
                {{--<div class="col-md-4">
                    <div class="card card-ai-detect py-3 px-3 align-items-center">
                        <h4>Spyderlab AI detect <i class="fa-solid fa-circle-info mx-1"></i></h4>
          ...
          <div class="col-md-4">
                        <div class="card card-ai-detect py-3 px-3 align-items-center">
                            <h3>Spyderlab AI detect <i class="fa-solid fa-circle-info mx-1"></i></h3>
            ...
            <div class="row">
                <div class="col-md-3">
                    <div class="card aml-risk-score py-3 px-3 align-items-center">
                        <h3>AML Risk Score<i class="fa-solid fa-circle-info fa-1x mx-2"></i></h3>
...
<div class="col-md-4">
    <div class="card crypto-favorites py-3 px-3">
        <h3><i class="fa-solid fa-star fa-1x mx-2"></i>Favorites</h3>
...
<div class="col-md-12">
    <div class="card Tranaction-Action-Analysis px-3 py-3">
        <div class="heading-Tranaction-Action-Analysis">
            <h3>Tranaction Action Analysis<i class="fa-solid fa-star fa-1x mx-2"></i></h3>
        </div>
...
<div class="col-md-12">
    <div class="card Address-Profile-Analysis px-3 py-3">
        <div class="heading-Address-Profile-Analysis">
            <h3>Address Profile Analysis<i class="fa-solid fa-star fa-1x mx-2"></i></h3>
    ...
    <div class="col-md-12">
        <div class="card Transaction-Time-Analysis px-3 py-3">
            <div class="heading-Transaction-Time-Analysis">
                <h3>Transaction Time Analysis<i class="fa-solid fa-star fa-1x mx-2"></i></h3>
...
<div class="col-md-12">
    <div class="card Transaction Graph px-3 py-3">
        <div class="Transaction-Graph-heading">
            <h3>Transaction Graph<i class="fa-solid fa-star fa-1x mx-2"></i></h3>
        </div>
        <div class="row">
            <div class="col-md-6">
                <div class="graph">
                 <button type="button" onclick="open_in_fullscreen()" class="btn btn-success"><i class="fa-solid fa-maximize"></i> View Fullscreen</button>
...
<script type="text/javascript">
    ...
    console.log('aml_risk_score :'+aml_risk_score);
