			...
			<div class="header-icons ml-auto d-flex">  
				...
				<div class="icon dropdown">
					...
					<ul class="dropdown-menu">
						...
						<li><a class="dropdown-item" href="{{route('history.index')}}"><i class="fa-solid fa-clock-rotate-left px-1"></i>History</a></li>
		...
		<ul class="nav flex-column">
			...
			<li class="nav-item">
				...
				<ul class="collapse submenu" id="cryptoSubMenu" aria-labelledby="Cryptomenu">
					...
					<li class="d-flex">
						<a href="{{route('alerts')}}" class="nav-link {{(Route::currentRouteName() == 'alerts')?'active':''}}"><img src="{{asset('assets/account/images/Sidebar/alert.svg')}} " height="30" alt=""> Alerts</a>
					</li>
				</ul>
			</li>
			...
			<li class="nav-item">
				<a class="nav-link" href="https://docs.spyderlab.org/" target="_blank"><img src="{{asset('assets/account/images/Sidebar/api.svg')}}" height="25" alt=""> API</a>
			</li>
		</ul>
	</div>
