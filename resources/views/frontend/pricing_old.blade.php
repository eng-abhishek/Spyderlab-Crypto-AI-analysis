				...
				<div class="col-md-3">
					<div class="card crypto-track-pricing-card">
						<div class="price-crypto-track-pricing crypto-pricing-bg-{{$key+1}}">
							...
							<h6></h6>
							@else
							<h6><i class="fa-solid fa-dollar-sign"></i> {{convertCurrency('INR','USD',round(($plansData->yearly_price),2)) }} per year</h6>
							@endif
				...
				<div class="col-md-3">
					<div class="card crypto-track-pricing-card">
						<div class="price-crypto-track-pricing crypto-pricing-bg-{{$key+1}}">
							...
							@if(($plansData->is_free == 'Y'))
							<h3><i class="fa-solid fa-dollar-sign"></i> {{convertCurrency('INR','USD',$plansData->yearly_price)}}<span>/{{$plansData->duration}}Days</span></h3>
							@else
							<h3><i class="fa-solid fa-dollar-sign"></i> {{convertCurrency('INR','USD',$plansData->yearly_price)}} <span>/Year</span></h3>
							@endif
