...
<div class="d-flex align-items-center mb-3">
	<div>
		<ul class="breadcrumb">
			...
			<li class="breadcrumb-item active">EDIT CREDIT PLAN</li>
		</ul>
		<h1 class="page-header">Edit Credit Plan</h1>
	</div>
</div>
...
<div class="card">
	<div class="card-body">
		{{ Form::model($record, array('route' => ['backend.plans.update', $record->id], 'id' => 'edit-plan-form')) }}
		@method('PUT')
		<div class="row mb-3">
...
@section('scripts')
{!! JsValidator::formRequest('App\Http\Requests\Backend\PlanRequest', '#edit-plan-form'); !!}
