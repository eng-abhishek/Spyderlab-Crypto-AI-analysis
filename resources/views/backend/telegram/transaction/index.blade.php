...
<div class="d-flex align-items-center mb-3">
	<div>
		...
		<h1 class="page-header">Transation Management</h1>
	</div>
</div>
	...
	<div class="card-body">
		<form>
			<div class="row justify-content-between">
				<div class="col-lg-3">
					{{ Form::select('status', ['' => 'Select Status', 'paid' => 'Paid', 'pending' => 'Pending','cancel' => 'Cancel'], null, array('class' => 'form-select my-3 filter_status')) }}
				</div>
...
<script type="text/javascript">
	$(document).ready(function(){
		...
		var table = $('#m_table_1').DataTable({
			...
			serverSide: true,
			ajax:{
				url:"{{ route('backend.telegram.transaction') }}",
				data: function (d) {
			...
			columns: [
	            ...
	            {data: 'payment_amount_in_usd', name: 'payment_amount_in_usd'},
