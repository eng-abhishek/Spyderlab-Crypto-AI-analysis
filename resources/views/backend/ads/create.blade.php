...
<div class="d-flex align-items-center mb-3">
	<div>
		<ul class="breadcrumb">
			...
			<li class="breadcrumb-item active"><a href="{{route('backend.ads.index')}}">Ads</a></li>
...
<div class="card">
	<div class="card-body">
		...
		{{ Form::open(array('route' => 'backend.ads.store', 'id'=>'add-ads-form', 'class' => 'm-form', 'files' => true)) }}
		...
		<div class="row">
			<div class="col-lg-12 col-md-12 text-end">
				...
				<a href="{{route('backend.ads.index')}}" class="btn btn-secondary">Back</a>
			</div>
		</div>
...
@section('scripts')
{!! JsValidator::formRequest('App\Http\Requests\Backend\AdsRequest', '#add-ads-form'); !!}
@endsection