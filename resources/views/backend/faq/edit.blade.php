...
<div class="d-flex align-items-center mb-3">
	<div>
		<ul class="breadcrumb">
			...
			<li class="breadcrumb-item active"><a href="{{route('backend.faq.index')}}">Faq</a></li>
...
<div class="card">
	<div class="card-body">
		...
		{{ Form::model($record, array('route' => ['backend.faq.update', $record->id], 'id'=>'edit-faq-form', 'class' => 'm-form', 'files' => true)) }}
        @method('PUT')
