...
<div class="d-flex align-items-center mb-3">
	<div>
		...
		<h1 class="page-header">Add Monitoring</h1>
	</div>
</div>
...
<div class="card">
	<div class="card-body">
		{{ Form::open(array('route' => 'backend.crypto-monitoring.store', 'id'=>'add-monitoring-form','files' => true)) }}
			...
			<form method="post" action="" id="renewForm">
				...
				<div class="modal-body">
					...
					<div class="row mb-3 timer_start d-none">
						...
						<div class="col-lg-4 col-md-4 timerStart">
...
@section('scripts')
{!! JsValidator::formRequest('App\Http\Requests\Backend\MonitoringRequest', '#add-monitoring-form'); !!}
