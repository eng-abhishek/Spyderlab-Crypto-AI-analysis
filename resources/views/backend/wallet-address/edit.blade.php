...
<div class="card">
	<div class="card-body">
		{{ Form::model($record, array('route' => ['backend.wallet-addresses.update', $record->id], 'id' => 'edit-wallet-address-form', 'files' => true)) }}
		@method('PUT')
		...
		<div class="row mb-3">
			...
			<div class="col-lg-9 col-md-8">
				...
				<div class="image-block">
					<img id="view-image" src="{{$record->image}}" class="" style="margin-top:10px;height: 50px;">
				</div>
				@error('image')
				<div class="invalid-feedback d-block">{{ $message }}</div>
				@enderror
...
@section('scripts')
{!! JsValidator::formRequest('App\Http\Requests\Backend\WalletAddressRequest', '#edit-wallet-address-form'); !!}
