...
<div class="card">
	<div class="card-body">
		...
		{{ Form::open(array('route' => 'backend.posts.store', 'id'=>'add-post-form', 'class' => 'm-form', 'files' => true)) }}
		<div class="m-portlet__body">	
			<div class="m-form__section m-form__section--first">
				...
				<div class="form-group m-form__group row mb-3">
					...
					<div class="col-lg-6">
						{{ Form::select('blog_tag_id[]', $blogTag, null, array('class' => 'form-control m-select2', 'id' => 'm_select2_3','multiple'=>'multiple')) }}
						@error('tag')
						<span class="invalid-feedback" role="alert">
							<strong>{{ $message }}</strong>
						</span>
				...
				<div class="form-group m-form__group row post_schedule_date {{(old('status') == 'Publish')?'':'d-none'}} mb-3">
				...
				<div class="row mb-3">
					...
					<div class="col-lg-9 col-md-8">
						<div class="form-check form-switch">
							<input type="checkbox" name="is_faq" class="is_faq form-check-input" id="customSwitch1" data-id="">
				...
				<div id="m_repeater_3" class="padding-top-20 is_faq_section d-none"> 
...
@endsection
@section('scripts')
{!! JsValidator::formRequest('App\Http\Requests\Backend\PostRequest', '#add-post-form'); !!}
