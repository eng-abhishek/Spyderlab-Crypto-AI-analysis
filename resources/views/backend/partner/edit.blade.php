...
<div class="d-flex align-items-center mb-3">
	<div>
		<ul class="breadcrumb">
			...
			<li class="breadcrumb-item active"><a href="{{route('backend.partners.index')}}">Partner</a></li>
...
<div class="card">
	<div class="card-body">
		...
		{{ Form::model($record, array('route' => ['backend.partners.update', $record->id], 'id'=>'edit-partners-form', 'class' => 'm-form', 'files' => true)) }}
		@method('PUT')
...
@section('scripts')
{!! JsValidator::formRequest('App\Http\Requests\Backend\PartnersRequest', '#edit-partners-form'); !!}
@endsection