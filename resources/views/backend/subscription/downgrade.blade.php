...
<div class="d-flex align-items-center mb-3">
	<div>
		<ul class="breadcrumb">
			...
			<li class="breadcrumb-item active">SUBSCRIPTION DOWNGRAD</li>
		</ul>
		<h1 class="page-header">Subscription Downgrad</h1>
	</div>
</div>
...
<div class="card">
	<div class="card-body">
		{{ Form::model($record ,array('route' => ['backend.subscription.downgrade', $record->id], 'id' => 'edit-subscription-form')) }}
		@method('POST')
